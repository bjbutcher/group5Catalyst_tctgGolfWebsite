    ...
    var cartNodes = this.props.data.map(function (cart) {
      return (
        <Cart
          ...
          cartemp={cart.employeeLastName + ", " + cart.employeeFirstName}
          cartcust={cart.playerFirstName + ", " + cart.playerLastName}
  ...
  render: function () {
    var optionNodes = this.props.data.map(function (empID) {
      return (
        ...
        >
          {empID.employeeID} - {empID.employeeLastName + ", " + empID.employeeFirstName}
        </option>
      );
    });
    return (
